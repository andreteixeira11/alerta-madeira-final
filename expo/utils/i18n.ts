...
const translations: TranslationDictionary = {
  pt: {
    ...
    'profile.galleryPermissionBody': 'Permita o acesso à fototeca para escolher uma fotografia para a sua foto de perfil.',
  ...
  en: {
    ...
    'profile.galleryPermissionBody': 'Allow photo library access to choose a picture for your profile photo.',
  ...
  es: {
    ...
    'profile.galleryPermissionBody': 'Permite el acceso a tu fototeca para elegir una imagen para tu foto de perfil.',
  ...
  fr: {
    ...
    'profile.galleryPermissionBody': 'Autorisez l’accès à votre photothèque pour choisir une image pour votre photo de profil.',
